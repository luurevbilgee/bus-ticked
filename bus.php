	...
	<main id="main">
		<div class="container">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-md-12">
						<button class="float-right btn btn-primary btn-sm" type="button" id="new_bus">Нэмэх <i
							...
							<table class="table table-striped table-bordered" id="bus-field">
								<thead>
									<tr>
										...
										<th class="text-center">Автобусны Дугаар</th>
										<th class="text-center">Автобусны нэр</th>
