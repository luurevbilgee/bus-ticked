		...
		<div class="container-fluid">
			<div class="col-lg-12">
				<?php if (isset($_SESSION['login_id'])): ?>
					<div class="row">
						<div class="col-md-12">
							<button class="float-right btn btn-primary btn-sm" type="button" id="new_schedule">Нэмэх <i
							...
							<table class="table table-striped table-bordered" id="schedule-field">
								...
								<thead>
									<tr>
										...
										<th class="text-center">Байрлал</th>
										<th class="text-center">Хөдлөх цаг</th>
										<th class="text-center">ETA</th>
										<th class="text-center">Суудлын тоо</th>
...
<script>
	$('#new_schedule').click(function () {
		uni_modal('Чиглэл нэмэх', 'manage_schedule.php')
	})
						...
						if (Object.keys(resp).length > 0) {
							...
							Object.keys(resp).map(k => {
								...
								if ('<?php echo isset($_SESSION['login_id']) ? 1 : 0 ?>' == 1) {
									...
									tr.append('<td><center><button class="btn btn-sm btn-primary mr-2 text-white book_now" data-id="' + resp[k].id + '"><strong>Хуваарь</strong></button></center></td>')
								}
