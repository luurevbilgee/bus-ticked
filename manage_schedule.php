	...
	<form id="manage_schedule">
		<div class="col-md-12">
			<div class="form-group mb-2">
				<label for="bus_id" class="control-label">Автобусны нэр</label>
			...
			<div class="form-group mb-2">
				<label for="from_location" class="control-label">Хаанаас</label>
			...
			?>
			<div class="form-group mb-2">
				<label for="to_location" class="control-label">Хаашаа</label>
				<select name="to_location" id="to_location" class="form-control" required>
					...
					<?php while ($row2 = $location->fetch_assoc()) { ?>
						<option value="<?php echo $row2['id'] ?>" <?php echo isset($meta['to_location']) && $meta['to_location'] == $row['id'] ? 'selected' : '' ?>>
			...
			<div class="form-group mb-2">
				<label for="departure_time" class="control-label"> Явах цаг</label>
			...
			<div class="form-group mb-2">
				<label for="eta" class="control-label">Очих цаг</label>
			...
			<div class="form-group mb-2">
				<label for="availability" class="control-label">Суудлын тоо</label>
			...
			<div class="form-group mb-2">
				<label for="price" class="control-label">Үнэ</label>
