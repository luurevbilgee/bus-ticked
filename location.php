		...
		<div class="container">
			<div class="col-lg-12">
				<?php if (isset($_SESSION['login_id'])): ?>
					<div class="row">
						<div class="col-md-12">
							<button class="float-right btn btn-primary btn-sm" type="button" id="new_location">Нэмэх <i
				...
				<div class="row">
					<div class="card col-md-12">
						<div class="card-header">
							<div class="card-title">Байрлалын жагсаалт</div>
						</div>
						<div class="card-body">
							<table class="table table-striped table-bordered" id="location-field">
								<thead>
									<tr>
										...
										<th class="text-center">Буудал</th>
										<th class="text-center">Хот</th>
										<th class="text-center">Аймаг\Дүүрэг</th>
...
<script>
	$('#new_location').click(function () {
		uni_modal('Шинэ байрлал нэмэх', 'manage_location.php')
	})
