	...
	<main id="main">
		<div class="container">
			<div class="col-lg-12">
				<div class="row">
					<div class="col-md-12">
						<button class="float-right btn btn-primary btn-sm" type="button" id="new_user">Нэмэх <i
...
<script>
	$('#new_user').click(function () {
		uni_modal('Шинээр админ нэмэх', 'manage_user.php')
	})
	...
	function remove_bus($id = '', $username = '') {
		start_load()
		$.ajax({
			url: 'delete_user.php',
			method: 'POST',
